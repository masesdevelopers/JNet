...
namespace Java.Awt.DesktopNs
{
    ...
    public partial class UserSessionListener : Java.Awt.DesktopNs.IUserSessionListener
    {
        ...
        {
            AddEventHandler("userSessionActivated", new global::System.EventHandler<CLRListenerEventArgs<CLREventDataMETHOD_STUB_LISTENER_FIRST_PARAMETER_PLACEHOLDER>>(UserSessionActivatedEventHandler));
            AddEventHandler("userSessionDeactivated", new global::System.EventHandler<CLRListenerEventArgs<CLREventDataMETHOD_STUB_LISTENER_FIRST_PARAMETER_PLACEHOLDER>>(UserSessionDeactivatedEventHandler));
        ...
        void UserSessionActivatedEventHandler(object sender, CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>> data)
        {
            ...
            data.TypedEventData.HasOverride = hasOverrideUserSessionActivated;
        }
        ...
        void UserSessionDeactivatedEventHandler(object sender, CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>> data)
        {
            ...
            methodToExecute.Invoke(data.EventData.GetAt<Java.Awt.DesktopNs.UserSessionEvent>(0));
            data.TypedEventData.HasOverride = hasOverrideUserSessionDeactivated;
        }
