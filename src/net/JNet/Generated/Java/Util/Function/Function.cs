...
namespace Java.Util.Function
{
    ...
    public partial class Function<T, R> : Java.Util.Function.IFunction<T, R>
    {
        ...
        {
            AddEventHandler("apply", new global::System.EventHandler<CLRListenerEventArgs<CLREventDataMETHOD_STUB_LISTENER_FIRST_PARAMETER_PLACEHOLDER>>(ApplyEventHandler));
            AddEventHandler("andThen", new global::System.EventHandler<CLRListenerEventArgs<CLREventDataMETHOD_STUB_LISTENER_FIRST_PARAMETER_PLACEHOLDER>>(AndThen<V, Arg0objectSuperR, Arg0ExtendsV>EventHandler));
            AddEventHandler("compose", new global::System.EventHandler<CLRListenerEventArgs<CLREventDataMETHOD_STUB_LISTENER_FIRST_PARAMETER_PLACEHOLDER>>(Compose<V, Arg0objectSuperV, Arg0ExtendsT>EventHandler));
        ...
        void AndThen<V, Arg0objectSuperR, Arg0ExtendsV>EventHandler(object sender, CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>> data)
        {
            ...
            data.TypedEventData.SetReturnValue(hasOverrideAndThen<V, Arg0objectSuperR, Arg0ExtendsV>, executionResult);
        }
        ...
        void Compose<V, Arg0objectSuperV, Arg0ExtendsT>EventHandler(object sender, CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>> data)
        {
            ...
            data.TypedEventData.SetReturnValue(hasOverrideCompose<V, Arg0objectSuperV, Arg0ExtendsT>, executionResult);
        }
