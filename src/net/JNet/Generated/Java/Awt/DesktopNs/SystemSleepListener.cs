...
namespace Java.Awt.DesktopNs
{
    ...
    public partial class SystemSleepListener : Java.Awt.DesktopNs.ISystemSleepListener
    {
        ...
        {
            AddEventHandler("systemAboutToSleep", new global::System.EventHandler<CLRListenerEventArgs<CLREventDataMETHOD_STUB_LISTENER_FIRST_PARAMETER_PLACEHOLDER>>(SystemAboutToSleepEventHandler));
            AddEventHandler("systemAwoke", new global::System.EventHandler<CLRListenerEventArgs<CLREventDataMETHOD_STUB_LISTENER_FIRST_PARAMETER_PLACEHOLDER>>(SystemAwokeEventHandler));
        ...
        void SystemAboutToSleepEventHandler(object sender, CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>> data)
        {
            ...
            data.TypedEventData.HasOverride = hasOverrideSystemAboutToSleep;
        }
        ...
        void SystemAwokeEventHandler(object sender, CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>> data)
        {
            ...
            methodToExecute.Invoke(data.EventData.GetAt<Java.Awt.DesktopNs.SystemSleepEvent>(0));
            data.TypedEventData.HasOverride = hasOverrideSystemAwoke;
        }
