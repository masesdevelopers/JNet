...
{
    #region MetaMessage declaration
    /// <summary>
    ...
    #region MetaMessage implementation
    public partial class MetaMessage
    {
        ...
        /// </summary>
        public static int META { get { if (!_METAReady) { _METAContent = SGetField<int>(LocalBridgeClazz, "META"); _METAReady = true; } return _METAContent; } }
        private static int _METAContent = default;
