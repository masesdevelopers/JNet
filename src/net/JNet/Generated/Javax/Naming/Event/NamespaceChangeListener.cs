...
namespace Javax.Naming.Event
{
    ...
    public partial class NamespaceChangeListener : Javax.Naming.Event.INamespaceChangeListener
    {
        ...
        {
            AddEventHandler("objectAdded", new global::System.EventHandler<CLRListenerEventArgs<CLREventDataMETHOD_STUB_LISTENER_FIRST_PARAMETER_PLACEHOLDER>>(ObjectAddedEventHandler));
            AddEventHandler("objectRemoved", new global::System.EventHandler<CLRListenerEventArgs<CLREventDataMETHOD_STUB_LISTENER_FIRST_PARAMETER_PLACEHOLDER>>(ObjectRemovedEventHandler));
            AddEventHandler("objectRenamed", new global::System.EventHandler<CLRListenerEventArgs<CLREventDataMETHOD_STUB_LISTENER_FIRST_PARAMETER_PLACEHOLDER>>(ObjectRenamedEventHandler));
            AddEventHandler("namingExceptionThrown", new global::System.EventHandler<CLRListenerEventArgs<CLREventDataMETHOD_STUB_LISTENER_FIRST_PARAMETER_PLACEHOLDER>>(NamingExceptionThrownEventHandler));
        ...
        void ObjectAddedEventHandler(object sender, CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>> data)
        {
            ...
            data.TypedEventData.HasOverride = hasOverrideObjectAdded;
        }
        ...
        void ObjectRemovedEventHandler(object sender, CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>> data)
        {
            ...
            methodToExecute.Invoke(data.EventData.GetAt<Javax.Naming.Event.NamingEvent>(0));
            data.TypedEventData.HasOverride = hasOverrideObjectRemoved;
        }
        ...
        void ObjectRenamedEventHandler(object sender, CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>> data)
        {
            ...
            methodToExecute.Invoke(data.EventData.GetAt<Javax.Naming.Event.NamingEvent>(0));
            data.TypedEventData.HasOverride = hasOverrideObjectRenamed;
        }
        ...
        void NamingExceptionThrownEventHandler(object sender, CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>> data)
        {
            ...
            data.TypedEventData.HasOverride = hasOverrideNamingExceptionThrown;
        }
