...
namespace Javax.Sql
{
    ...
    public partial class ConnectionEventListener : Javax.Sql.IConnectionEventListener
    {
        ...
        {
            AddEventHandler("connectionClosed", new global::System.EventHandler<CLRListenerEventArgs<CLREventDataMETHOD_STUB_LISTENER_FIRST_PARAMETER_PLACEHOLDER>>(ConnectionClosedEventHandler));
            AddEventHandler("connectionErrorOccurred", new global::System.EventHandler<CLRListenerEventArgs<CLREventDataMETHOD_STUB_LISTENER_FIRST_PARAMETER_PLACEHOLDER>>(ConnectionErrorOccurredEventHandler));
        ...
        void ConnectionClosedEventHandler(object sender, CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>> data)
        {
            ...
            data.TypedEventData.HasOverride = hasOverrideConnectionClosed;
        }
        ...
        void ConnectionErrorOccurredEventHandler(object sender, CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>> data)
        {
            ...
            methodToExecute.Invoke(data.EventData.GetAt<Javax.Sql.ConnectionEvent>(0));
            data.TypedEventData.HasOverride = hasOverrideConnectionErrorOccurred;
        }
