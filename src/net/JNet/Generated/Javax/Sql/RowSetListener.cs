...
namespace Javax.Sql
{
    ...
    public partial class RowSetListener : Javax.Sql.IRowSetListener
    {
        ...
        {
            AddEventHandler("cursorMoved", new global::System.EventHandler<CLRListenerEventArgs<CLREventDataMETHOD_STUB_LISTENER_FIRST_PARAMETER_PLACEHOLDER>>(CursorMovedEventHandler));
            AddEventHandler("rowChanged", new global::System.EventHandler<CLRListenerEventArgs<CLREventDataMETHOD_STUB_LISTENER_FIRST_PARAMETER_PLACEHOLDER>>(RowChangedEventHandler));
            AddEventHandler("rowSetChanged", new global::System.EventHandler<CLRListenerEventArgs<CLREventDataMETHOD_STUB_LISTENER_FIRST_PARAMETER_PLACEHOLDER>>(RowSetChangedEventHandler));
        ...
        void CursorMovedEventHandler(object sender, CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>> data)
        {
            ...
            data.TypedEventData.HasOverride = hasOverrideCursorMoved;
        }
        ...
        void RowChangedEventHandler(object sender, CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>> data)
        {
            ...
            methodToExecute.Invoke(data.EventData.GetAt<Javax.Sql.RowSetEvent>(0));
            data.TypedEventData.HasOverride = hasOverrideRowChanged;
        }
        ...
        void RowSetChangedEventHandler(object sender, CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>> data)
        {
            ...
            methodToExecute.Invoke(data.EventData.GetAt<Javax.Sql.RowSetEvent>(0));
            data.TypedEventData.HasOverride = hasOverrideRowSetChanged;
        }
