...
namespace Java.Awt.DesktopNs
{
    ...
    public partial class ScreenSleepListener : Java.Awt.DesktopNs.IScreenSleepListener
    {
        ...
        {
            AddEventHandler("screenAboutToSleep", new global::System.EventHandler<CLRListenerEventArgs<CLREventDataMETHOD_STUB_LISTENER_FIRST_PARAMETER_PLACEHOLDER>>(ScreenAboutToSleepEventHandler));
            AddEventHandler("screenAwoke", new global::System.EventHandler<CLRListenerEventArgs<CLREventDataMETHOD_STUB_LISTENER_FIRST_PARAMETER_PLACEHOLDER>>(ScreenAwokeEventHandler));
        ...
        void ScreenAboutToSleepEventHandler(object sender, CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>> data)
        {
            ...
            data.TypedEventData.HasOverride = hasOverrideScreenAboutToSleep;
        }
        ...
        void ScreenAwokeEventHandler(object sender, CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>> data)
        {
            ...
            methodToExecute.Invoke(data.EventData.GetAt<Java.Awt.DesktopNs.ScreenSleepEvent>(0));
            data.TypedEventData.HasOverride = hasOverrideScreenAwoke;
        }
