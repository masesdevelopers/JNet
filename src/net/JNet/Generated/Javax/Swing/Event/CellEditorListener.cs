...
namespace Javax.Swing.Event
{
    ...
    public partial class CellEditorListener : Javax.Swing.Event.ICellEditorListener
    {
        ...
        {
            AddEventHandler("editingCanceled", new global::System.EventHandler<CLRListenerEventArgs<CLREventDataMETHOD_STUB_LISTENER_FIRST_PARAMETER_PLACEHOLDER>>(EditingCanceledEventHandler));
            AddEventHandler("editingStopped", new global::System.EventHandler<CLRListenerEventArgs<CLREventDataMETHOD_STUB_LISTENER_FIRST_PARAMETER_PLACEHOLDER>>(EditingStoppedEventHandler));
        ...
        void EditingCanceledEventHandler(object sender, CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>> data)
        {
            ...
            data.TypedEventData.HasOverride = hasOverrideEditingCanceled;
        }
        ...
        void EditingStoppedEventHandler(object sender, CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>> data)
        {
            ...
            methodToExecute.Invoke(data.EventData.GetAt<Javax.Swing.Event.ChangeEvent>(0));
            data.TypedEventData.HasOverride = hasOverrideEditingStopped;
        }
