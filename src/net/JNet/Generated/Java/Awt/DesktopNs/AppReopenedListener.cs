...
namespace Java.Awt.DesktopNs
{
    ...
    public partial class AppReopenedListener : Java.Awt.DesktopNs.IAppReopenedListener
    {
        ...
        {
            AddEventHandler("appReopened", new global::System.EventHandler<CLRListenerEventArgs<CLREventDataMETHOD_STUB_LISTENER_FIRST_PARAMETER_PLACEHOLDER>>(AppReopenedEventHandler));
        ...
        void AppReopenedEventHandler(object sender, CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>> data)
        {
            ...
            data.TypedEventData.HasOverride = hasOverrideAppReopened;
        }
