...
namespace Javax.Print.Event
{
    ...
    public partial class PrintJobAttributeListener : Javax.Print.Event.IPrintJobAttributeListener
    {
        ...
        {
            AddEventHandler("attributeUpdate", new global::System.EventHandler<CLRListenerEventArgs<CLREventDataMETHOD_STUB_LISTENER_FIRST_PARAMETER_PLACEHOLDER>>(AttributeUpdateEventHandler));
        ...
        void AttributeUpdateEventHandler(object sender, CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>> data)
        {
            ...
            data.TypedEventData.HasOverride = hasOverrideAttributeUpdate;
        }
