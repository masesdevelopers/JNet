...
namespace Java.Util.Function
{
    ...
    public partial class Consumer<T> : Java.Util.Function.IConsumer<T>
    {
        ...
        {
            AddEventHandler("accept", new global::System.EventHandler<CLRListenerEventArgs<CLREventDataMETHOD_STUB_LISTENER_FIRST_PARAMETER_PLACEHOLDER>>(AcceptEventHandler));
            AddEventHandler("andThen", new global::System.EventHandler<CLRListenerEventArgs<CLREventDataMETHOD_STUB_LISTENER_FIRST_PARAMETER_PLACEHOLDER>>(AndThen<Arg0objectSuperT>EventHandler));
        ...
        void AndThen<Arg0objectSuperT>EventHandler(object sender, CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>> data)
        {
            ...
            data.TypedEventData.SetReturnValue(hasOverrideAndThen<Arg0objectSuperT>, executionResult);
        }
