...
public final class DoublePredicate implements org.mases.jcobridge.IJCListener, java.util.function.DoublePredicate {
    ...
    //@Override
    public boolean test(double arg0)double arg0 {
    ...
    //@Override
    public java.util.function.DoublePredicate and(java.util.function.DoublePredicate arg0)java.util.function.DoublePredicate arg0 {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
    ...
    //@Override
    public java.util.function.DoublePredicate andDefault(java.util.function.DoublePredicate arg0)METHOD_STUB_EXTEND_EXCEPTIONS_PLACEHOLDER {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
    ...
    //@Override
    public java.util.function.DoublePredicate negateDefault()METHOD_STUB_EXTEND_EXCEPTIONS_PLACEHOLDER {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        return java.util.function.DoublePredicate.super.negate();
    }
    //@Override
    public java.util.function.DoublePredicate or(java.util.function.DoublePredicate arg0)java.util.function.DoublePredicate arg0 {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
    ...
    //@Override
    public java.util.function.DoublePredicate orDefault(java.util.function.DoublePredicate arg0)METHOD_STUB_EXTEND_EXCEPTIONS_PLACEHOLDER {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
