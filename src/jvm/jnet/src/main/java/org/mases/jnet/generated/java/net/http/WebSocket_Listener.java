...
public final class WebSocket_Listener implements org.mases.jcobridge.IJCListener, java.net.http.WebSocket.Listener {
    ...
    //@Override
    public java.util.concurrent.CompletionStage onBinary(java.net.http.WebSocket arg0, java.nio.ByteBuffer arg1, boolean arg2)java.net.http.WebSocket arg0, java.nio.ByteBuffer arg1, boolean arg2 {
    ...
    //@Override
    public java.util.concurrent.CompletionStage onClose(java.net.http.WebSocket arg0, int arg1, java.lang.String arg2)java.net.http.WebSocket arg0, int arg1, java.lang.String arg2 {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
    ...
    //@Override
    public java.util.concurrent.CompletionStage onPing(java.net.http.WebSocket arg0, java.nio.ByteBuffer arg1)java.net.http.WebSocket arg0, java.nio.ByteBuffer arg1 {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
    ...
    //@Override
    public java.util.concurrent.CompletionStage onPong(java.net.http.WebSocket arg0, java.nio.ByteBuffer arg1)java.net.http.WebSocket arg0, java.nio.ByteBuffer arg1 {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
    ...
    //@Override
    public java.util.concurrent.CompletionStage onText(java.net.http.WebSocket arg0, java.lang.CharSequence arg1, boolean arg2)java.net.http.WebSocket arg0, java.lang.CharSequence arg1, boolean arg2 {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
    ...
    //@Override
    public void onError(java.net.http.WebSocket arg0, java.lang.Throwable arg1)java.net.http.WebSocket arg0, java.lang.Throwable arg1 {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
    ...
    //@Override
    public void onOpen(java.net.http.WebSocket arg0)java.net.http.WebSocket arg0 {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
