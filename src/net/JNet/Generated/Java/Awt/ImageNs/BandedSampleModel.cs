...
namespace Java.Awt.ImageNs
{
    ...
    public partial class BandedSampleModel
    {
        #region Constructors
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.desktop/java/awt/image/BandedSampleModel.html#%3Cinit%3E(int,int,int,int,int[],int[])"/>
        /// </summary>
        ...
        public BandedSampleModel(int arg0, int arg1, int arg2, int arg3, int[] arg4, int[] arg5)
            : base(arg0, arg1, arg2, arg3, arg4, arg5)
        {
        }
        /// <summary>
        /// <see href="https://docs.oracle.com/en/java/javase/11/docs/api/java.desktop/java/awt/image/BandedSampleModel.html#%3Cinit%3E(int,int,int,int)"/>
        /// </summary>
        /// <param name="arg0"><see cref="int"/></param>
        /// <param name="arg1"><see cref="int"/></param>
        /// <param name="arg2"><see cref="int"/></param>
        /// <param name="arg3"><see cref="int"/></param>
        public BandedSampleModel(int arg0, int arg1, int arg2, int arg3)
